...
| Runtime | deterministic safety and execution scenarios | `31/31` | generated by `pnpm evals` |
| Browser agent | WebArena-Verified Hard-30 registered subset | harness registered; score not yet claimed | [method](BROWSER.md) |
